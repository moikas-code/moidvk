...
export const SHARING_LEVELS = {
  micro: { maxLines: 10, context: 2, description: 'Minimal snippet (up to 10 lines)' },
  function: { maxLines: 50, context: 5, description: 'Function-level snippet (up to 50 lines)' },
  component: {
    maxLines: 200,
    context: 10,
    description: 'Component-level snippet (up to 200 lines)',
  },
};
