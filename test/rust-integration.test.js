...
describe('Rust Integration Tests', () => {
  ...
  test('VectorOperations can be instantiated', () => {
    ...
    const vectorOps = new VectorOperations(config);
  ...
  test('FileSearch can be instantiated', () => {
    ...
    const fileSearch = new FileSearch(fileConfig);
  ...
  test('Backend info is consistent', () => {
    // Provide proper configuration for Rust backends
    const vectorConfig = {
      useSimd: true,
      useParallel: true,
      similarityThreshold: 0.7,
    ...
    const vectorOps = new VectorOperations(vectorConfig);
    const fileSearch = new FileSearch(fileConfig);
